        ...
        <form className="row g-3 pt-1" onSubmit={handleSubmit}>
          ...
          <div className="col-md-6">
            ...
            >
              ...
              <option value="laptop">Science Fiction</option>
              <option value="headphone">Horror</option>
              <option value="mobile">Self-help</option>
              <option value="electronics">Romance</option>
              <option value="toys">Thriller</option>
              <option value="fashion">Crime Fiction</option>
            </select>
          </div>
